...
entry:
  ...
  %array.param = getelementptr inbounds [2 x i32], ptr %arr, i32 0
  call void @func(ptr %array.param)
  %arr.idx0 = getelementptr inbounds [2 x [2 x i32]], ptr %arr, i32 0, i32 1
  %arr.idx14 = getelementptr inbounds [2 x i32], ptr %arr.idx0, i32 0, i32 0
