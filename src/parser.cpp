...
// bool Parser::currentTokenType(TokenType type)
// {
//     return type==currentToken_.tokenType_;
// }
...
//     func->name_ = tokens_[currentPos_ - 2].value_;
...
//     consume(TokenType::PUNCTUATION_LEFT_BRACE,"Expected '{' after ')'");
//     // 函数体
...
//     if (!currentTokenType(TokenType::PUNCTUATION_RIGHT_PAREN) )
//     {
//         do
//         {
